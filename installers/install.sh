...
# Open port 2087 in firewalld if it's active
if systemctl is-active --quiet firewalld; then
    echo "--> Opening port 2087 in firewall..."
    firewall-cmd --permanent --add-port=2087/tcp >/dev/null 2>&1
...
echo -e "${GREEN}=====================================================${NC}"
echo -e "Access the Control Plane API: ${YELLOW}http://${PUBLIC_IP}:2087${NC}"
